...
downloadLastVersion() {
	curl -L -s -o $HOME/.wsend/wsend https://raw.github.com/vannell/wsend/custom/wsend
	chmod +x $HOME/.wsend/wsend
    #supporting files as well
	curl -L -s -o $HOME/.wsend/README.md https://raw.github.com/vannell/wsend/custom/README.md
	curl -L -s -o $HOME/.wsend/COPYING https://raw.github.com/vannell/wsend/custom/COPYING
	curl -L -s -o $HOME/.wsend/version https://raw.github.com/vannell/wsend/custom/version
	curl -L -s -o $HOME/.wsend/update.sh https://raw.github.com/vannell/wsend/custom/update.sh
}
...
if [ -d "$HOME/.wsend" ]; then
  ...
  latestVersion=$(curl -L -s https://raw.github.com/vannell/wsend/custom/version)
